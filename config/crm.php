...
$permissionGroups = [
    ...
    'products' => [
        'label' => 'Sản phẩm và bảng giá',
        'permissions' => [
            'products.view' => 'Xem danh mục sản phẩm',
            'products.create' => 'Tạo sản phẩm',
            'products.update' => 'Cập nhật sản phẩm',
            'products.delete' => 'Xóa sản phẩm',
            'price-books.view' => 'Xem bảng giá',
            'price-books.create' => 'Tạo bảng giá',
            'price-books.update' => 'Cập nhật bảng giá',
            'price-books.delete' => 'Xóa bảng giá',
        ],
    ],
    'pipelines' => [
        'label' => 'Pipeline',
    ...
    'rbac' => [
        ...
        'route_access_exceptions' => [
            'record_policy' => [
                ...
                'quotes.public-link.store' => 'QuoteController and QuotePolicy@issue',
        ...
        'roles' => [
            ...
            'sales-manager' => [
                ...
                'permissions' => [
                    ...
                    'price-books.view', 'price-books.create', 'price-books.update', 'price-books.delete',
                    'pipelines.view',
            ...
            'sales' => [
                ...
                'permissions' => [
                    ...
                    'products.view', 'price-books.view',
                    'pipelines.view',
                    'sales-playbook.view',
                    'activities.view', 'activities.create', 'activities.update', 'activities.delete',
