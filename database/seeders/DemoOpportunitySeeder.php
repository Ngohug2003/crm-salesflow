...
final class DemoOpportunitySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $opportunityDataList = [
            [
                'code' => 'OPP-DEMO-001',
                'title' => 'Trang bị nội thất văn phòng doanh nghiệp Vin',
                'amount' => 150000000.00,
                'stage' => $stages->firstWhere('code', 'proposal-quote') ?? $stages[2] ?? $stages[0],
                'expected_close_date' => now()->addDays(20)->format('Y-m-d'),
                'notes' => 'Khách hàng yêu cầu bổ sung khu họp nhanh và tủ hồ sơ.',
                'is_won' => false,
                'is_lost' => false,
            ],
            [
                'code' => 'OPP-DEMO-002',
                'title' => 'Tư vấn bố trí khu làm việc FPT Telecom',
                'amount' => 85000000.00,
            ...
            [
                'code' => 'OPP-DEMO-003',
                'title' => 'Mở rộng 80 chỗ ngồi văn phòng năm 2026',
                'amount' => 220000000.00,
            ...
            [
                'code' => 'OPP-DEMO-004',
                'title' => 'Khảo sát nội thất văn phòng chuỗi siêu thị',
                'amount' => 45000000.00,
                'stage' => $stages->firstWhere('code', 'initial-contact') ?? $stages[0],
                'expected_close_date' => now()->addDays(45)->format('Y-m-d'),
                'notes' => 'Tiếp cận ban đầu thông qua triển lãm Vietbuild.',
                'is_won' => false,
                'is_lost' => false,
            ],
            [
                'code' => 'OPP-DEMO-005',
                'title' => 'Cung cấp bàn ghế cho văn phòng chi nhánh',
                'amount' => 30000000.00,
                ...
                'lost_reason' => 'Đối thủ cạnh tranh giảm giá 30% và cam kết giao sớm hơn.',
                'notes' => 'Đối tác chọn nhà cung cấp trọn gói khác.',
                'is_won' => false,
                'is_lost' => true,
            ],
        ];
